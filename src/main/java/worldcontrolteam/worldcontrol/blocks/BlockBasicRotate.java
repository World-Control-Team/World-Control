...
public abstract class BlockBasicRotate extends BlockBasicTileProvider{
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase entity, ItemStack stack) {
        ...
        world.setBlockState(pos, state.withProperty(FACING, this.getFFE(world, pos, entity, false)), 2);
    }
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
        return this.getDefaultState().withProperty(FACING, this.getFFE(worldIn, pos, placer, false));
    }
    @Override
