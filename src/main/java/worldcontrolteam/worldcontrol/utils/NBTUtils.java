...
public class NBTUtils {
    ...
    public static ItemStack getItemStack(NBTTagCompound tagCompound){
        try {
            ...
            WCUtility.error(String.format("Itemstack failed to transfer via NBT. Args are: Item: %s, Meta: %s, Stacksize: %s, Tag: %s", tagCompound.getString(ITEM_NAME), tagCompound.getInteger(METADATA), tagCompound.getInteger(STACKSIZE), tagCompound.getString(NBTTAG)));
        }
        return null;
    }
