...
public class NBTUtils {
    ...
    public static NBTTagCompound writeEnumFacing(NBTTagCompound tagCompound, EnumFacing facing) {
        tagCompound.setInteger(FACING, facing.getIndex());
        return tagCompound;
    }

    public static EnumFacing getEnumFacing(NBTTagCompound tag) {
        return EnumFacing.getFront(tag.getInteger(FACING));
    }
